...
var _user$project$Entry$viewEntry = function (entry) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mdl-shadow--4dp'),
			_1: {
				ctor: '::',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'PostList') {
			if (_p0._0.ctor === 'Ok') {
				var _p2 = _p0._0._0;
				var _p1 = A2(_elm_lang$core$Debug$log, 'OK:', _p2);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Main$Model, _p2, model.mdl),
					{ctor: '[]'});
			} else {
				var _p3 = A2(
...
var _user$project$Main$getPostList = function () {
	var url = 'http://bitterjug.com/wp-json/wp/v2/posts/';
	return A2(
