...
var _user$project$Entry$decodeContent = A2(
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Entry$Entry = F2(
	function (a, b) {
		return {title: a, content: b};
	});
var _user$project$Entry$decodeEntry = A3(_elm_lang$core$Json_Decode$map2, _user$project$Entry$Entry, _user$project$Entry$decodeTitle, _user$project$Entry$decodeContent);
var _user$project$Entry$decodeEntries = _elm_lang$core$Json_Decode$list(_user$project$Entry$decodeEntry);

var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {entries: a, displayMode: b, mdl: c};
	});
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'PostList':
				if (_p0._0.ctor === 'Ok') {
					var _p2 = _p0._0._0;
					var _p1 = A2(_elm_lang$core$Debug$log, 'OK:', _p2);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
			...
			case 'Previous':
				var _p4 = model.displayMode;
				if (_p4.ctor === 'EntryList') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								displayMode: _user$project$Main$SingleEntry(_p4._0 + 1)
							}),
						{ctor: '[]'});
				}
			default:
				var _p5 = model.displayMode;
				if (_p5.ctor === 'EntryList') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								displayMode: _user$project$Main$SingleEntry(_p5._0 - 1)
							}),
						{ctor: '[]'});
				}
		}
...
var _user$project$Main$view = function (model) {
						...
						_0: A5(
							...
							model.mdl,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$Previous),
										_1: {ctor: '[]'}
									}
								}
							},
	...
	var entries = function () {
		var _p6 = model.displayMode;
		if (_p6.ctor === 'EntryList') {
			return model.entries;
		} else {
			return A2(
				_elm_lang$core$List$take,
				1,
				A2(_elm_lang$core$List$drop, _p6._0, model.entries));
		}
	}();
	return A4(
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Entry$viewEntries(entries),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$Main$init = {
	...
	_0: A3(
		...
		{
			ctor: '::',
			_0: A2(_user$project$Entry$Entry, 'title', 'Loading...'),
			_1: {ctor: '[]'}
		},
		_user$project$Main$SingleEntry(0),
