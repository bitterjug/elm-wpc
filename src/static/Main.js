...
var _user$project$Entry$viewEntry = function (entry) {
	return A2(
		_elm_lang$html$Html$main_,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mdl-shadow--4dp post'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('mdl-typography--headline'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Entry$viewEntries = function (entries) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Entry$viewEntry, entries));
};
var _user$project$Entry$decodeSlug = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'slug',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Entry$decodeTitle = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'title',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Entry$decodeContent = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'content',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Entry$Entry = F3(
	function (a, b, c) {
		return {title: a, content: b, slug: c};
	});
var _user$project$Entry$decodeEntry = A4(_elm_lang$core$Json_Decode$map3, _user$project$Entry$Entry, _user$project$Entry$decodeTitle, _user$project$Entry$decodeContent, _user$project$Entry$decodeSlug);
var _user$project$Entry$decodeEntries = _elm_lang$core$Json_Decode$list(_user$project$Entry$decodeEntry);
var _user$project$Entry$loading = A3(_user$project$Entry$Entry, '...', 'Loading...', '');

var _user$project$Main$findPost = F2(
	function (model, slug) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			A2(
				...
				_elm_lang$core$List$head(
					A2(
						...
						function (_p0) {
							var _p1 = _p0;
							return _elm_lang$core$Native_Utils.eq(_p1._1, slug);
						},
						A2(
							_elm_lang$core$List$indexedMap,
							F2(
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {entries: a, route: b, mdl: c};
	});
var _user$project$Main$NotFound = {ctor: 'NotFound'};
var _user$project$Main$SingleEntry = function (a) {
	return {ctor: 'SingleEntry', _0: a};
};
var _user$project$Main$EntryList = {ctor: 'EntryList'};
var _user$project$Main$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Main$EntryList, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Main$SingleEntry,
				A2(
...
var _user$project$Main$findPage = function (location) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Main$NotFound,
		A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Main$routeParser, location));
};
...
var _user$project$Main$view = function (model) {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A5(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Icon$i('arrow_back'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A5(
											...
											{
												ctor: '::',
												_0: _debois$elm_mdl$Material_Icon$i('arrow_forward'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
	...
	var content = function () {
		...
		switch (_p6.ctor) {
			case 'EntryList':
				return _user$project$Entry$viewEntries(model.entries);
			case 'SingleEntry':
				var index = A2(_user$project$Main$findPost, model, _p6._0);
				var entries = A2(
					_elm_lang$core$List$take,
					1,
					A2(_elm_lang$core$List$drop, index, model.entries));
				return _user$project$Entry$viewEntries(entries);
			default:
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('mdl-cell mdl-cell--2-col mdl-cell--hide-phone mdl-cell--hide-tablet'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('mdl-cell mdl-cell--8-col'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Main$getPostList = function () {
	var url = 'posts.json';
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$PostList,
		A2(_elm_lang$http$Http$get, url, _user$project$Entry$decodeEntries));
}();
var _user$project$Main$init = function (location) {
	return {
		...
		_0: A3(
			...
			_user$project$Main$EntryList,
			_debois$elm_mdl$Material$model),
		_1: _user$project$Main$getPostList
	};
};
var _user$project$Main$main = A2(
	...
	_user$project$Main$locationChange,
	{
		...
		subscriptions: function (model) {
			return A2(_debois$elm_mdl$Material_Layout$subs, _user$project$Main$Mdl, model.mdl);
		}
	})();
